...
<body class="authentication-bg">
    ...
    <div class="home-btn d-none d-sm-block">
        <a href="{{route('admin.dashboard.index')}}" class="text-dark"><i class="mdi mdi-home-variant h2"></i></a>
    </div>
    ...
    $("#changepasswordform").validate({
        ...
        messages: {
            ...
            'newpassword': {
                ...
                minlength: "Please Enter Password Minimum 8 characters!",
                maxlength: "Please Enter Password Maximum 15 characters!",
            },
            'confirmpassword': {
