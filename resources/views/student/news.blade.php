            ...
            <div class="col-xl-9 col-lg-9 col-md-8 col-sm-12">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="news-box">
                            <div class="news-img-holder">
                                <img src="{{ asset('student/img/news/7.jpg')}}" class="img-responsive" alt="research">
                                <ul class="news-date2">
                                    <li>27 Dec</li>
                                    <li>2021</li>
                                </ul>
                            </div>
                            <h3 class="title-news-left-bold"><a href="#">How To Build HTML To WordPress Site?</a></h3>
                            <ul class="title-bar-high news-comments">
                                <li><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span>By</span> Admin</a>
                                </li>
                            ...
                            <p>Bimply dummy text of the printing and typesetting istryrem Ipsum has been the industry's
                                standard dummy text ever when an unknown printer.</p>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="news-box">
                            <div class="news-img-holder">
                                <img src="{{ asset('student/img/news/8.jpg')}}" class="img-responsive" alt="research">
                                <ul class="news-date2">
                                    <li>20 Dec</li>
                                    <li>2021</li>
                                </ul>
                            </div>
                            <h3 class="title-news-left-bold"><a href="#">The printing and typesetting industry</a></h3>
                            <ul class="title-bar-high news-comments">
                                <li><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span>By</span> Admin</a>
                                </li>
                                <li><a href="#"><i class="fa fa-tags" aria-hidden="true"></i>Business</a></li>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="news-box">
                            <div class="news-img-holder">
                                <img src="{{ asset('student/img/news/9.jpg')}}" class="img-responsive" alt="research">
                                <ul class="news-date2">
                                    <li>12 Dec</li>
                                    <li>2021</li>
                                </ul>
                            </div>
                            <h3 class="title-news-left-bold"><a href="#">Business printing pesetting industry</a></h3>
                            <ul class="title-bar-high news-comments">
                                <li><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span>By</span> Admin</a>
                                </li>
                                <li><a href="#"><i class="fa fa-tags" aria-hidden="true"></i>Business</a></li>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="news-box">
                            <div class="news-img-holder">
                                <img src="{{ asset('student/img/news/10.jpg')}}" class="img-responsive" alt="research">
                                <ul class="news-date2">
                                    <li>03 Dec</li>
                                    <li>2021</li>
                                </ul>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="news-box">
                            <div class="news-img-holder">
                                <img src="{{ asset('student/img/news/11.jpg')}}" class="img-responsive" alt="research">
                                <ul class="news-date2">
                                    <li>25 Nov</li>
                                    <li>2021</li>
                                </ul>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="news-box">
                            <div class="news-img-holder">
                                <img src="{{ asset('student/img/news/12.jpg')}}" class="img-responsive" alt="research">
                                <ul class="news-date2">
                                    <li>19 Nov</li>
                                    <li>2021</li>
                                </ul>
