                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted mt-3 mb-0"><span class="text-success mr-1"><i
                                    class="mdi mdi-arrow-up-bold ml-1"></i>2.65%</span> since last week
                        </p>
                    </div>
                </div>
            </div> <!-- end col-->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted mt-3 mb-0"><span class="text-danger mr-1"><i
                                    class="mdi mdi-arrow-down-bold ml-1"></i>0.82%</span> since last week
                        </p>
                    </div>
                </div>
            </div> <!-- end col-->
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted mt-3 mb-0"><span class="text-danger mr-1"><i
                                    class="mdi mdi-arrow-down-bold ml-1"></i>6.24%</span> since last week
                        </p>
                    </div>
                </div>
            </div> <!-- end col-->
            ...
            <div class="col-md-6 col-xl-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted mt-3 mb-0"><span class="text-success mr-1"><i
                                    class="mdi mdi-arrow-up-bold ml-1"></i>10.51%</span> since last week
                        </p>
                    </div>
                </div>
            </div> <!-- end col-->
                            ...
                            <ul class="list-inline main-chart mb-0">
                                ...
                                <li class="list-inline-item chart-border-left mr-0">
                                    <h3><span data-plugin="counterup">3.6</span>%<span
                                            class="text-muted d-inline-block font-size-15 ml-3">Conversation
                                            Ratio</span></h3>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center no-gutters mt-3">
                            <div class="col-sm-3">
                                <p class="text-truncate mt-1 mb-0"><i
                                        class="mdi mdi-circle-medium text-primary mr-2"></i> Desktops </p>
                            </div>
                        ...
                        <div class="row align-items-center no-gutters mt-3">
                            <div class="col-sm-3">
                                <p class="text-truncate mt-1 mb-0"><i class="mdi mdi-circle-medium text-info mr-2"></i>
                                    iPhones </p>
                            </div>
                            <div class="col-sm-9">
                                <div class="progress mt-1" style="height: 6px;">
                        ...
                        <div class="row align-items-center no-gutters mt-3">
                            <div class="col-sm-3">
                                <p class="text-truncate mt-1 mb-0"><i
                                        class="mdi mdi-circle-medium text-success mr-2"></i> Android </p>
                            </div>
                            <div class="col-sm-9">
                                <div class="progress mt-1" style="height: 6px;">
                        ...
                        <div class="row align-items-center no-gutters mt-3">
                            <div class="col-sm-3">
                                <p class="text-truncate mt-1 mb-0"><i
                                        class="mdi mdi-circle-medium text-warning mr-2"></i> Tablets </p>
                            </div>
                            <div class="col-sm-9">
                                <div class="progress mt-1" style="height: 6px;">
                        ...
                        <div class="row align-items-center no-gutters mt-3">
                            <div class="col-sm-3">
                                <p class="text-truncate mt-1 mb-0"><i
                                        class="mdi mdi-circle-medium text-purple mr-2"></i> Cables </p>
                            </div>
                            <div class="col-sm-9">
                                <div class="progress mt-1" style="height: 6px;">
                                ...
                                <table class="table table-borderless table-centered table-nowrap">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-muted font-weight-semibold text-right"><i
                        ...
                        <ol class="activity-feed mb-0 pl-2" data-simplebar style="max-height: 336px;">
                            <li class="feed-item">
                                <div class="feed-item-list">
                                    <p class="text-muted mb-1 font-size-13">Today<small
                                            class="d-inline-block ml-1">12:20 pm</small></p>
                            ...
                            <li class="feed-item">
                                <p class="text-muted mb-1 font-size-13">22 Jul, 2020 <small
                                        class="d-inline-block ml-1">12:36 pm</small></p>
                            ...
                            <li class="feed-item">
                                <p class="text-muted mb-1 font-size-13">18 Jul, 2020 <small
                                        class="d-inline-block ml-1">07:56 am</small></p>
                            ...
                            <li class="feed-item">
                                <p class="text-muted mb-1 font-size-13">10 Jul, 2020 <small
                                        class="d-inline-block ml-1">08:42 pm</small></p>
                            ...
                            <li class="feed-item">
                                <p class="text-muted mb-1 font-size-13">23 Jun, 2020 <small
                                        class="d-inline-block ml-1">12:22 am</small></p>
                                <p class="mt-0 mb-0">Zack Wetass, sed porta finibus, risus Chris Wallace
                                    Commented <span class="text-primary"> Developer Moreno</span></p>
                            </li>
                            <li class="feed-item pb-1">
                                <p class="text-muted mb-1 font-size-13">20 Jun, 2020 <small
                                        class="d-inline-block ml-1">09:48 pm</small></p>
                                <p class="mt-0 mb-0">Zack Wetass, Chris combined Commented <span class="text-primary">UX
                                        Murphy</span></p>
                            </li>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="float-right">
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" id="dropdownMenuButton4" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="mt-3 text-center">
                            <a href="#" class="text-primary font-size-14 font-weight-medium">View All Sources <i
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="javascript: void(0);"
                                                class="text-body font-weight-bold">#MB2540</a> </td>
                                        <td>Neal Matthews</td>
                                        <td>
                                            07 Oct, 2019
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="javascript: void(0);"
                                                class="text-body font-weight-bold">#MB2541</a> </td>
                                        <td>Jamal Burnett</td>
                                        <td>
                                            07 Oct, 2019
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="javascript: void(0);"
                                                class="text-body font-weight-bold">#MB2542</a> </td>
                                        <td>Juan Mitchell</td>
                                        <td>
                                            06 Oct, 2019
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="javascript: void(0);"
                                                class="text-body font-weight-bold">#MB2543</a> </td>
                                        <td>Barry Dick</td>
                                        <td>
                                            05 Oct, 2019
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="javascript: void(0);"
                                                class="text-body font-weight-bold">#MB2544</a> </td>
                                        <td>Ronald Taylor</td>
                                        <td>
                                            04 Oct, 2019
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="javascript: void(0);"
                                                class="text-body font-weight-bold">#MB2545</a> </td>
                                        <td>Jacob Hunter</td>
                                        <td>
                                            04 Oct, 2019
                                        </td>
